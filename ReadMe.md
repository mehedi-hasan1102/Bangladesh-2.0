...
Fully static website using pure HTML & CSS

Organized folder structure for easy code navigation

Includes custom assets, images, and basic animations (if applied)
